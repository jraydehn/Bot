    ...
    if auth is not None:
        ...
        for c in ladder:
            ...
            if dec_c.side == "no" and offset_c <= 0:
                ...
                continue
            # Minimum offset for BTC NO: near-ATM NO (< 0.10% OTM) requires 61%+ break-even
            # but achieves only 54% live win rate. 0.5% offset NO wins 89% in backtest.
            # Revert: copy paper_trade_runner_v2.py → paper_trade_runner.py
