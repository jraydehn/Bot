...
def evaluate_trade(
    ...
    # 15-month backtest shows log-normal overestimates YES probability by ~10pp.
    # 0.65× factor corrects this. Applied here so it runs exactly once per evaluation.
    ...
    #
    # Revert: copy decision_v1.py → decision.py
